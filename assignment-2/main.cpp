...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Faisal Ahmed", NULL, NULL);
    if (window == NULL)
    {
    ...
    // ------------------------------------------------------------------
    float vertices[] = {
        // Triangle 1 (Top-Left, obtuse)
    -0.5f,  0.85f, 0.0f,   // left-top
    -0.1f,  0.85f, 0.0f,   // right-top  (long base)
    -0.55f,  0.75f, 0.0f,   // middle-bottom (creates obtuse angle)

    // Triangle 2 (Bottom-Right, obtuse)
     0.1f, -0.85f, 0.0f,   // left-bottom
     0.5f, -0.85f, 0.0f,   // right-bottom (long base)
     0.55f, -0.75f, 0.0f  // middle-top (creates obtuse angle)
    }; 
