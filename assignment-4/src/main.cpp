...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "0432320005101129", NULL, NULL);
    if (window == NULL)
    {
    ...
    // 🔥 ADDED FLAG (DO NOT CHANGE ANYTHING ELSE)
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 🔥 PRESS R ONCE TO STOP ANIMATION
        ...
        else
        {
            ...
            glUniform4f(vertexColorLocation, 1.0f, cyanValue, 1.0f, 1.0f);
        }
